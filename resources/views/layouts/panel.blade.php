...
<div class="page">
    ...
    @if ((Auth::user()->isAdmin() && Auth::user()->can('Setting')) || Auth::user()->isSuperAdmin() )
                    <li class="nav-item">
                        ...
                        <ul class="nav-sub">
                                <li class="nav-sub-item">
                                    <a class="nav-sub-link" href="{{route('users.index')}}">العملاء</a>
                                </li>
                               
                                <li class="nav-sub-item">
                                    <a class="nav-sub-link" href="{{ url('admin/detections/open') }}">زيارات مفتوحة</a>
                                </li>
                                <li class="nav-sub-item">
                                    <a class="nav-sub-link" href="{{ url('admin/detections/pending') }}">زيارات قيد التنفيذ</a>
                                </li>
                                <li class="nav-sub-item">
                                    <a class="nav-sub-link" href="{{ url('admin/detections/inprogress') }}">زيارات تحت التنفيذ</a>
                                </li>
                                <li class="nav-sub-item">
                                    <a class="nav-sub-link" href="{{ url('admin/detections/complete') }}">زيارات منتهية</a>
                                </li>
                                <li class="nav-sub-item">
                                    <a class="nav-sub-link" href="{{ url('admin/detections/cancelled') }}">زيارات ملغاة</a>
                                </li>
                                <li class="nav-sub-item">
                                    <a class="nav-sub-link" href="{{ route('files.index') }}">الملفات</a>
                                </li>
                                <li class="nav-sub-item">
                                    <a class="nav-sub-link" href="{{ route('bills.index') }}">الفواتير</a>
                                </li>
...
{{--     @if ((Auth::user()->isAdmin() && Auth::user()->can('Setting')) || Auth::user()->isSuperAdmin() )
                    <li class="nav-item">
                        <a class="nav-link with-sub" href="#">
                            ...
                            <span class="sidemenu-label">فروع المركز</span><i class="angle fe fe-chevron-left"></i></a>
                        <ul class="nav-sub">
                                <li class="nav-sub-item">
                                    <a class="nav-sub-link" href="">قائمة الفروع</a>
                                </li>
...
{{-- الاطباء --}} 
    @if ((Auth::user()->isAdmin() && Auth::user()->can('Setting')) || Auth::user()->isSuperAdmin() )
                    <li class="nav-item">
                        ...
                        <ul class="nav-sub">
                                <li class="nav-sub-item">
                                    <a class="nav-sub-link" href="{{ route('doctors.index') }}">قائمة الاطباء</a>
                                </li>
                                {{--  <li class="nav-sub-item">
                                    <a class="nav-sub-link" href="{{route('dates.index')}}">اضافة المواعيد</a>
                                </li>  --}}
                                <li class="nav-sub-item">
                                    <a class="nav-sub-link" href="{{route('prices.index')}}">اضافة الأسعار</a>
                                </li>
                        </ul>
                    </li>
                @endif
...
{{-- التخصصات --}} 
    @if ((Auth::user()->isAdmin() && Auth::user()->can('Setting')) || Auth::user()->isSuperAdmin() )
                    <li class="nav-item">
                        ...
                        <ul class="nav-sub">
                                <li class="nav-sub-item">
                                    <a class="nav-sub-link" href="{{ route('specialtys.index') }}">قائمة التخصصات</a>
                                </li>
...
{{-- الحسابات --}} 
    @if ((Auth::user()->isAdmin() && Auth::user()->can('Setting')) || Auth::user()->isSuperAdmin() )
                    <li class="nav-item">
                        ...
                        <ul class="nav-sub">
                                <li class="nav-sub-item">
                                    <a class="nav-sub-link" href="{{ route('expenses.index') }}">المصروفات</a>
                                </li>
...
{{-- العروض --}} 
    @if ((Auth::user()->isAdmin() && Auth::user()->can('Setting')) || Auth::user()->isSuperAdmin() )
                    <li class="nav-item">
                        ...
                        <ul class="nav-sub">
                                <li class="nav-sub-item">
                                    <a class="nav-sub-link" href="{{ route('offers.index') }}"> قائمة العروض</a>
                                </li>
...
{{-- التقارير --}} 
    @if ((Auth::user()->isAdmin() && Auth::user()->can('Setting')) || Auth::user()->isSuperAdmin() )
                    <li class="nav-item">
                        ...
                        <ul class="nav-sub">
                                <li class="nav-sub-item">
                                    <a class="nav-sub-link" href="{{ route('treasury') }}">كشف حركة الخزينة</a>
                                </li>
                                <li class="nav-sub-item">
                                    <a class="nav-sub-link" href="{{ route('dates') }}">تقرير مواعيد الحجز</a>
                                </li>
            ...
            <div class="main-header-right">
                ...
                <div class="dropdown d-md-flex">
                    <ul class="list-group">
                        ...
                        <div class="media">
                            <li>
                                <a class="btn btn-link btn btn-outline-secondary" data-toggle="tooltip" data-placement="top"  rel="alternate" hreflang="{{ $localeCode }}" href="{{ LaravelLocalization::getLocalizedURL($localeCode, null, [], true) }}">
                                    {{ $properties['native'] }}
                                </a>
                            </li>
                            </div>
