...
@section('User')
    active
@endsection
@section('title','زيارات قيد التنفيذ')
@section('content')
                    ...
                    <table id="table" class="table table-bordered table-striped text-center">
                        ...
                        <tbody>
                            ...
                            @foreach ($detections as $row)
                                ...
                                @if($row->status == 2)
                                    <td><a href="{{ url('admin/detection_inprogressEd',$row->id) }}" class="btn btn-primary">{{ __('زيارة قيد التنفيذ') }}</a></td>
                                    <td><a href="{{ url('admin/detection_cancelledEd',$row->id) }}" class="btn btn-danger">{{ __('إلغاء الزيارة') }}</a></td>
                                @endif
