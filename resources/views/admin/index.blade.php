...
@section('home','active')
@section('title')
    @lang('admin.dashborad')
@endsection
@section('content')
    <!-- Page Header -->
    <div class="page-header">
        <div>
            <h2 class="main-content-title tx-24 mg-b-5">@lang('admin.welcometodashboard')</h2>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="#">@lang('admin.homepage')</a></li>
                <li class="breadcrumb-item active" aria-current="page">@lang('admin.dashborad')</li>
            </ol>
        </div>
        <div class="d-flex">
