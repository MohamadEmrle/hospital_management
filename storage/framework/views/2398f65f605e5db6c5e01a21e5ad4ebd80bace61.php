                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <!-- form start -->
                                    <form method="POST" action="<?php echo e(route('specialtys.store')); ?>"
                            ...
                            <?php $__currentLoopData = $specialtys; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $specialty): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <tr>
                                    ...
                                    <?php if(LaravelLocalization::getCurrentLocale() == 'en'): ?>
                                        <td><?php echo e($specialty->spename); ?></td>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            ...
                                            <button type="button" class="btn btn-success dropdown-item" data-toggle="modal"
                                                data-target="#modal-edit<?php echo e($specialty->id); ?>"><i
                                                    class="fas fa-user-edit"></i>التحرير</button>
                                            <button type="button" class="dropdown-item" data-toggle="modal"
                                                data-target="#modal-delete<?php echo e($specialty->id); ?>"><i style="color:red"
                                ...
                                <!-- Delete Modal -->
                                <div class="modal fade" id="modal-delete<?php echo e($specialty->id); ?>">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                            ...
                                            <div class="modal-footer justify-content-between">
                                                ...
                                                <form action="<?php echo e(route('specialtys.destroy', $specialty->id)); ?>"
                                                    method="POST">
                                                    <?php echo csrf_field(); ?>
                                ...
                                <!-- /.modal -->
                                <!-- Change Modal -->
                                <div class="modal fade" id="modal-edit<?php echo e($specialty->id); ?>">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                            ...
                                            <div class="modal-body">
                                                <!-- form start -->
                                                <form method="POST"
                                                    action="<?php echo e(route('specialtys.update', $specialty->id)); ?>"
                                                    enctype="multipart/form-data">
                                                    <?php echo csrf_field(); ?>
                                                    <?php echo method_field('PATCH'); ?>
                                                    <input type="hidden" name="id" value="<?php echo e($specialty->id); ?>">
                                                    <div class="card-body">
                                                        <div class="form-group">
                                                    <?php if(LaravelLocalization::getCurrentLocale() == 'en'): ?>
                                                            <label for="exampleInputEmail1">الاسم بالإنكليزي</label>
                                                            <input name="spename_en" value="<?php echo e($specialty->spename); ?>" type="text" class="form-control"
                                                                id="exampleInputEmail1" placeholder="Enter name" required
                                                                value="<?php echo e($specialty->name); ?>" required>
                                                        </div>
                                                    <?php elseif(LaravelLocalization::getCurrentLocale() == 'ar'): ?>
                                                        <div class="form-group">
                                                            <label for="exampleInputEmail1">الاسم بالعربي</label>
                                                            <input name="spename_ar" value="<?php echo e($specialty->spename); ?>" type="text" class="form-control"
                                                                id="exampleInputEmail1" placeholder="Enter name" required
                                                                value="<?php echo e($specialty->name); ?>" required>
                                                        </div>
...
<?php echo $__env->make('layouts.panel', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\adminpanellaravel\resources\views/admin/specialtys/index.blade.php ENDPATH**/ ?>