                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <!-- form start -->
                                                <form method="POST"
                                                    action="<?php echo e(url('admin/detection_update', $row->id)); ?>"
                                                    enctype="multipart/form-data">
                                                    <?php echo csrf_field(); ?>
                                                                    ...
                                                                    <select name="doctor_id" id="doctor_id"
                                                                        ...
                                                                        <?php $__currentLoopData = $doctors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                            <option value="<?php echo e($row->id); ?>"
                                                                                <?php if(old('id') === $row->id): ?> <?php if($row->id): echo 'selected'; endif; ?> <?php endif; ?>>
...
<?php echo $__env->make('layouts.panel', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\adminpanellaravel\resources\views/admin/detections/detection_open.blade.php ENDPATH**/ ?>