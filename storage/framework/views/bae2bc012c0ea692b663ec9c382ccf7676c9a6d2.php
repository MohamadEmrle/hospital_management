...
<?php $__env->startSection('User'); ?>
    active
<?php $__env->stopSection(); ?>
<?php $__env->startSection('title','الأسعار'); ?>
                        ...
                        <?php endif; ?>
                                <td class="text-center">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        <button type="button" class="btn btn-success dropdown-item" data-toggle="modal" data-target="#modal-edit<?php echo e($price->id); ?>" ><i  class="fas fa-user-edit"></i>التحرير</button>
                                        <button type="button" class="dropdown-item" data-toggle="modal" data-target="#modal-delete<?php echo e($price->id); ?>" ><i style="color:red" class="fas fa-user-minus"></i>الحذف</button>
                                    </div>
                                </td>
                            ...
                            <!-- Delete Modal -->
                            <div class="modal fade" id="modal-delete<?php echo e($price->id); ?>">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                            ...
                            <!-- /.modal -->
                            <!-- Change Modal -->
                            <div class="modal fade" id="modal-edit<?php echo e($price->id); ?>">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                        ...
                                        <div class="modal-body">
                                            <!-- form start -->
                                        <form  method="POST" action="<?php echo e(url('admin/prices/update',$price->id)); ?>"  enctype="multipart/form-data">
                                                <?php echo csrf_field(); ?>
                                            
                                                <div class="card-body">
                                                    <div class="form-group">
                                                        <label for="exampleInputEmail1">نسبة الدكتور</label>
                                                        <input name="Profits_Dr" value="<?php echo e($price->Profits_Dr); ?>" type="text" class="form-control"  placeholder="نسبة الدكتور" required autocomplete="off" >
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="exampleInputEmail1">نسبة المركز</label>
                                                        <input name="Profits_center" value="<?php echo e($price->Profits_center); ?>" type="text" class="form-control"  placeholder="نسبة المركز" required autocomplete="off" >
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="exampleInputEmail1">القيمة الإجمالية</label>
                                                        <input name="total_value" value="<?php echo e($price->total_value); ?>" type="text" class="form-control"  placeholder="القيمة الإجمالية" required autocomplete="off" >
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="exampleInputEmail1">الطبيب</label>
                                                        <select name="doctor_id" class="form-control select-lg select2">
...
<?php echo $__env->make('layouts.panel', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\adminpanellaravel\resources\views/admin/prices/index.blade.php ENDPATH**/ ?>