<link href="<?php echo e(asset('css/image.css')); ?>" rel="stylesheet" />
                ...
                <div class="card-body">
                    ...
                    <div class="panel profile-cover">
                        <div class="profile-cover__img">
                            <img class="img" src="<?php echo e(asset('images/doctors/' . $show[0]->photo)); ?>" alt="NoImage">
                            <?php if(LaravelLocalization::getCurrentLocale() == 'en'): ?>
                                <h3 class="h3">Name: <?php echo e($show[0]->name_en); ?></h3>
                                <h3 class="h3">Specialty: <?php echo e($show[0]->specialtys->spename_en); ?></h3>
                            <?php elseif(LaravelLocalization::getCurrentLocale() == 'ar'): ?>
                                <h3 class="h3">الأسم: <?php echo e($show[0]->name_ar); ?></h3>
                                <h3 class="h3">التخصص: <?php echo e($show[0]->specialtys->spename_ar); ?></h3>
                            <?php endif; ?>
                        </div>
                    </div>
                    ...
                    <div class="profile-cover__info">
                        <ul class="nav">
                            <li><strong><?php echo e($dates); ?></strong> المواعيد</li>
                ...
                <div class="row">
                        ...
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="dates-tab" data-toggle="tab" href="#dates" role="tab"
                                    aria-controls="dates" aria-selected="true"><?php echo e(__('المواعيد')); ?></a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link active" id="prices-tab" data-toggle="tab" href="#prices" role="tab"
                                    aria-controls="prices" aria-selected="true"><?php echo e(__('الفواتير')); ?></a>
                            </li>
                            <li class="nav-item">
                                                        ...
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <!-- form start -->
                                                                    <form method="POST"
                                                                        action="<?php echo e(url('admin/dates/store', $show[0]->id)); ?>"
                                                    ...
                                                    <table id="table"
                                                        ...
                                                        <tbody>
                                                            <?php
                                                                $number = 0;
                                                            ?>
                                                            <?php $__currentLoopData = $datesDoctor; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $date): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <?php
                                                                    $number++;
                                                                ?>
                                                                <tr>
                                                                    ...
                                                                    <td class="text-center">
                                                                        ...
                                                                        <div class="dropdown-menu"
                                                                            ...
                                                                            <button type="button"
                                                                                ...
                                                                                data-toggle="modal"
                                                                                data-target="#modal-edit<?php echo e($date->id); ?>"><i
                                                                                    class="fas fa-user-edit"></i>التحرير</button>
                                                                            <button type="button" class="dropdown-item"
                                                                                data-toggle="modal"
                                                                                data-target="#modal-delete<?php echo e($date->id); ?>"><i
                                                                                    style="color:red"
                                                                ...
                                                                <div class="modal fade"
                                                                    id="modal-delete<?php echo e($date->id); ?>">
                                                                    <div class="modal-dialog">
                                                                        <div class="modal-content">
                                                                            <div class="modal-header">
                                                                            ...
                                                                            <div class="modal-body">
                                                                                <h5>لا تحذف الموعد `<?php echo e($date->day); ?>` هل
                                                                                    انت واثق؟ </h5>
                                                                            </div>
                                                                            <div
                                                                                ...
                                                                                <form
                                                                                    action="<?php echo e(route('dates.destroy', $date->id)); ?>"
                                                                                    method="POST">
                                                                                    <?php echo csrf_field(); ?>
                                                                ...
                                                                <!-- Change Modal -->
                                                                <div class="modal fade"
                                                                    id="modal-edit<?php echo e($date->id); ?>">
                                                                    <div class="modal-dialog">
                                                                        <div class="modal-content">
                                                                            <div class="modal-header">
                                                                            ...
                                                                            <div class="modal-body">
                                                                                <!-- form start -->
                                                                                <form method="POST"
                                                                                    action="<?php echo e(route('dates.update', $date->id)); ?>"
                                                                                    enctype="multipart/form-data">
                                                                                    <?php echo csrf_field(); ?>
                                                                                    ...
                                                                                    <div class="card-body">
                                                                                        <div class="form-group">
                                                                                            <label
                                                                                                ...
                                                                                                الساعة</label>
                                                                                            <input name="for_hour"
                                                                                                value="<?php echo e($date->for_hour); ?>"
                                                                                                type="time"
                                                                                                class="form-control"
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th><?php echo e(__('رقم الزيارة')); ?></th>
                                                    <th><?php echo e(__('حالة الزيارة')); ?></th>
                                                    <th><?php echo e(__('الموعد')); ?></th>
                                            ...
                                            ?>
                                            <tbody>
                                                    <?php $__currentLoopData = $detectionDoctor; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <?php
                                                            $Serial++;
                                                        ?>
                                                        <tr>
                    ...
                    <div class="tab-pane fade  btnsaveoption" id="prices" role="tabpanel"
                            ...
                            <form action="https://demo.freaktemplate.com/singleclinic/admin/updateworkinghours"
                                ...
                                ?>
                                <tbody>
                                    <?php if(isset($billDoctor) && $billDoctor->count() > 0): ?>
                                        <?php $__currentLoopData = $billDoctor; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php
                                                $Serial++;
                                            ?>
                                            <tr>
...
<?php echo $__env->make('layouts.panel', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\adminpanellaravel\resources\views/admin/doctors/show.blade.php ENDPATH**/ ?>