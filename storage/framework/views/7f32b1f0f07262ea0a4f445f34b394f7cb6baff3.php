...
<div id="global-loader">
  <img src="<?php echo e(asset('dashboard/assets/img/loader.svg')); ?>" class="loader-img" alt="Loader">
</div>
<!-- End Loader -->
...
<!-- Jquery js-->
<script src="<?php echo e(asset('dashboard/assets/plugins/jquery/jquery.min.js')); ?>"></script>

<!-- Bootstrap js-->
<script src="<?php echo e(asset('dashboard/assets/plugins/bootstrap/js/popper.min.js')); ?>"></script>
<script src="<?php echo e(asset('dashboard/assets/plugins/bootstrap/js/bootstrap-rtl.js')); ?>"></script>

<!-- Perfect-scrollbar js -->
<script src="<?php echo e(asset('dashboard/assets/plugins/perfect-scrollbar/perfect-scrollbar.min-rtl.js')); ?>"></script>

<!-- Sidemenu js -->
<script src="<?php echo e(asset('dashboard/assets/plugins/sidemenu/sidemenu-rtl.js')); ?>"></script>

<!-- Sidebar js -->
<script src="<?php echo e(asset('dashboard/assets/plugins/sidebar/sidebar-rtl.js')); ?>"></script>

<!-- Select2 js-->
<script src="<?php echo e(asset('dashboard/assets/plugins/select2/js/select2.min.js')); ?>"></script>

<!-- Internal Chart.Bundle js-->
<script src="<?php echo e(asset('dashboard/assets/plugins/chart.js/Chart.bundle.min.js')); ?>"></script>

<!-- Peity js-->
<script src="<?php echo e(asset('dashboard/assets/plugins/peity/jquery.peity.min.js')); ?>"></script>

<!-- Internal Morris js -->
<script src="<?php echo e(asset('dashboard/assets/plugins/raphael/raphael.min.js')); ?>"></script>
<script src="<?php echo e(asset('dashboard/assets/plugins/morris.js/morris.min.js')); ?>"></script>

<!-- Circle Progress js-->
<script src="<?php echo e(asset('dashboard/assets/js/circle-progress.min.js')); ?>"></script>
<script src="<?php echo e(asset('dashboard/assets/js/chart-circle.js')); ?>"></script>

<!-- Internal Dashboard js-->
<script src="<?php echo e(asset('dashboard/assets/js/index.js')); ?>"></script>

<!-- Sticky js -->
<script src="<?php echo e(asset('dashboard/assets/js/sticky.js')); ?>"></script>

<!-- Custom js -->
<script src="<?php echo e(asset('dashboard/assets/js/custom.js')); ?>"></script>

<!-- Switcher js -->
<script src="<?php echo e(asset('dashboard/assets/switcher/js/switcher-rtl.js')); ?>"></script>
...
</html><?php /**PATH C:\xampp\htdocs\adminpanellaravel\resources\views/layouts/auth.blade.php ENDPATH**/ ?>