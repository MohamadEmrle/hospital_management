...
<?php $__env->startSection('User'); ?>
    active
<?php $__env->stopSection(); ?>
<?php $__env->startSection('title', 'زيارات منتهية'); ?>
<?php $__env->startSection('content'); ?>

    <!-- Page Header -->
    <div class="page-header">
        <div>
            <h2 class="main-content-title tx-24 mg-b-5"> زيارات منتهية </h2>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="<?php echo e(route('home')); ?>">الرئيسية</a></li>
                <li class="breadcrumb-item active" aria-current="page">زيارات منتهية</li>
            </ol>
        </div>
    </div>
    <div class="row">
                    ...
                    success: function(data) {
                        ...
                        if (data['dates']) {
                            $.each(data['dates'], function(key, value) {
                                $("#day_name").append("<option id='" + value['id'] +
                                    "'>" + value['day'] + "</option>");
                            });
                        }
...
<?php echo $__env->make('layouts.panel', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\adminpanellaravel\resources\views/admin/detections/detection_complete.blade.php ENDPATH**/ ?>