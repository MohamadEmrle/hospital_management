...
<?php $__env->startSection('User'); ?>
    active
<?php $__env->stopSection(); ?>
<?php $__env->startSection('title','زيارات قيد التنفيذ'); ?>
<?php $__env->startSection('content'); ?>

    <!-- Page Header -->
    <div class="page-header">
        <div>
            <h2 class="main-content-title tx-24 mg-b-5"> زيارات قيد التنفيذ </h2>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="<?php echo e(route('home')); ?>">الرئيسية</a></li>
                <li class="breadcrumb-item active" aria-current="page">زيارات قيد التنفيذ</li>
            </ol>
        </div>
    </div>
    <div class="row">
                    ...
                    <table id="table" class="table table-bordered table-striped text-center">
                        ...
                        <tbody>
                            ...
                            <?php $__currentLoopData = $detections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <?php if($row->status == 2): ?>
                                    <td><a href="<?php echo e(url('admin/detection_inprogressEd',$row->id)); ?>" class="btn btn-primary"><?php echo e(__('زيارة قيد التنفيذ')); ?></a></td>
                                    <td><a href="<?php echo e(url('admin/detection_cancelledEd',$row->id)); ?>" class="btn btn-danger"><?php echo e(__('إلغاء الزيارة')); ?></a></td>
                                <?php endif; ?>
...
<?php echo $__env->make('layouts.panel', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\adminpanellaravel\resources\views/admin/detections/detection_pending.blade.php ENDPATH**/ ?>