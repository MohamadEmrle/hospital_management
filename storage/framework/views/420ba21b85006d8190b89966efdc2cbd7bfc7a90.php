                                    ...
                                    <form  method="POST" action="<?php echo e(route('services.store')); ?>"  enctype="multipart/form-data">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="services_provider" type="text" class="form-control"  placeholder="أدخل اسم الخدمة" required autocomplete="off" >
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleInputEmail1">اسم الخدمة</label>
                                                <input name="name" type="text" class="form-control"  placeholder="أدخل اسم الخدمة" required autocomplete="off" >
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="value" type="number" class="form-control"  placeholder="أدخل قيمة الخدمة" required autocomplete="off" >
                                            </div>
                                            <div class="form-group">
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        <button type="button" class="btn btn-success dropdown-item" data-toggle="modal" data-target="#modal-edit<?php echo e($service->id); ?>" ><i  class="fas fa-user-edit"></i>التحرير</button>
                                        <button type="button" class="dropdown-item" data-toggle="modal" data-target="#modal-delete<?php echo e($service->id); ?>"><i style="color:red" class="fas fa-user-minus"></i>الحذف</button>
                                    </div>
                                </td>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer justify-content-between">
                                            ...
                                            <form action="<?php echo e(url('admin/services/destroy',$service->id)); ?>" method="POST">
                                                <?php echo csrf_field(); ?>
                            ...
                            <div class="modal fade" id="modal-edit<?php echo e($service->id); ?>">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <!-- form start -->
                                        <form  method="POST" action="<?php echo e(url('admin/services/update',$service->id)); ?>"  enctype="multipart/form-data">
                                            <?php echo csrf_field(); ?>
                                            <?php echo method_field('PATCH'); ?>
                                                <div class="card-body">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="exampleInputEmail1">اسم مقدم الخدمة</label>
                                                        <input name="services_provider" value="<?php echo e($service->services_provider); ?>" type="text" class="form-control"  placeholder="أدخل اسم الخدمة" required autocomplete="off" >
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="exampleInputEmail1">اسم الخدمة</label>
                                                        <input name="name" value="<?php echo e($service->name); ?>" type="text" class="form-control"  placeholder="أدخل اسم الخدمة" required autocomplete="off" >
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="exampleInputEmail1">وصف الخدمة</label>
                                                    ...
                                                    <div class="form-group">
                                                        <label for="exampleInputEmail1">قيمة الخدمة</label>
                                                        <input name="value" value="<?php echo e($service->value); ?>" type="number" class="form-control"  placeholder="أدخل قيمة الخدمة" required autocomplete="off" >
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="exampleInputEmail1">طريقة الدفع</label>
                                                        <select name="payment" class="form-control select-lg select2">
...
<?php echo $__env->make('layouts.panel', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\adminpanellaravel\resources\views/admin/services/index.blade.php ENDPATH**/ ?>